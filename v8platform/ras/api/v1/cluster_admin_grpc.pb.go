...
type ClusterAdminServiceClient interface {
	Admins(ctx context.Context, in *GetClusterAdminsRequest, opts ...grpc.CallOption) (*GetClusterAdminsResponse, error)
	AddAdmin(ctx context.Context, in *AddClusterAdminRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	DeleteAdmin(ctx context.Context, in *DeleteClusterAdminRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *clusterAdminServiceClient) Admins(ctx context.Context, in *GetClusterAdminsRequest, opts ...grpc.CallOption) (*GetClusterAdminsResponse, error) {
	out := new(GetClusterAdminsResponse)
...
func (c *clusterAdminServiceClient) AddAdmin(ctx context.Context, in *AddClusterAdminRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (c *clusterAdminServiceClient) DeleteAdmin(ctx context.Context, in *DeleteClusterAdminRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type ClusterAdminServiceServer interface {
	Admins(context.Context, *GetClusterAdminsRequest) (*GetClusterAdminsResponse, error)
	AddAdmin(context.Context, *AddClusterAdminRequest) (*emptypb.Empty, error)
	DeleteAdmin(context.Context, *DeleteClusterAdminRequest) (*emptypb.Empty, error)
}
...
func (UnimplementedClusterAdminServiceServer) Admins(context.Context, *GetClusterAdminsRequest) (*GetClusterAdminsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Admins not implemented")
}
func (UnimplementedClusterAdminServiceServer) AddAdmin(context.Context, *AddClusterAdminRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddAdmin not implemented")
}
func (UnimplementedClusterAdminServiceServer) DeleteAdmin(context.Context, *DeleteClusterAdminRequest) (*emptypb.Empty, error) {
...
func _ClusterAdminService_Admins_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetClusterAdminsRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterAdminServiceServer).Admins(ctx, req.(*GetClusterAdminsRequest))
	}
...
func _ClusterAdminService_AddAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterAdminServiceServer).AddAdmin(ctx, req.(*AddClusterAdminRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ClusterAdminService_DeleteAdmin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteClusterAdminRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClusterAdminServiceServer).DeleteAdmin(ctx, req.(*DeleteClusterAdminRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ClusterAdminService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "v8platform/ras/api/v1/cluster_admin.proto",
}
