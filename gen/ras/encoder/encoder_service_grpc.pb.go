...
type EncoderServiceClient interface {
	...
	//packet debug func
	PacketEncode(ctx context.Context, in *v1.Packet, opts ...grpc.CallOption) (*wrapperspb.BytesValue, error)
	PacketDecode(ctx context.Context, in *wrapperspb.BytesValue, opts ...grpc.CallOption) (*v1.Packet, error)
	// Конвертирует любой сообщение в пакет
	// Сообщение должно реализовавать интерфейс пакета
	// * PacketType()
	// * Format()
	NewPacket(ctx context.Context, in *anypb.Any, opts ...grpc.CallOption) (*v1.Packet, error)
	...
	UnpackPacket(ctx context.Context, in *v1.Packet, opts ...grpc.CallOption) (*anypb.Any, error)
}
...
func (c *encoderServiceClient) PacketEncode(ctx context.Context, in *v1.Packet, opts ...grpc.CallOption) (*wrapperspb.BytesValue, error) {
	out := new(wrapperspb.BytesValue)
...
func (c *encoderServiceClient) PacketDecode(ctx context.Context, in *wrapperspb.BytesValue, opts ...grpc.CallOption) (*v1.Packet, error) {
	out := new(v1.Packet)
...
func (c *encoderServiceClient) NewPacket(ctx context.Context, in *anypb.Any, opts ...grpc.CallOption) (*v1.Packet, error) {
	out := new(v1.Packet)
...
func (c *encoderServiceClient) UnpackPacket(ctx context.Context, in *v1.Packet, opts ...grpc.CallOption) (*anypb.Any, error) {
	out := new(anypb.Any)
...
type EncoderServiceServer interface {
	...
	//packet debug func
	PacketEncode(context.Context, *v1.Packet) (*wrapperspb.BytesValue, error)
	PacketDecode(context.Context, *wrapperspb.BytesValue) (*v1.Packet, error)
	// Конвертирует любой сообщение в пакет
	// Сообщение должно реализовавать интерфейс пакета
	// * PacketType()
	// * Format()
	NewPacket(context.Context, *anypb.Any) (*v1.Packet, error)
	// Аналог NewPacket только еще сразу кодирует пакет в байты
	...
	// * ras.protocol.v1.EndpointOpenAck
	// * ras.protocol.v1.EndpointMessage
	UnpackPacket(context.Context, *v1.Packet) (*anypb.Any, error)
}
...
func _EncoderService_PacketEncode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EncoderServiceServer).PacketEncode(ctx, req.(*v1.Packet))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _EncoderService_UnpackPacket_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EncoderServiceServer).UnpackPacket(ctx, req.(*v1.Packet))
	}
	return interceptor(ctx, in, info, handler)
}
