...
type InfobasesServiceClient interface {
	...
	GetInfobase(ctx context.Context, in *GetInfobaseRequest, opts ...grpc.CallOption) (*v1.InfobaseInfo, error)
}
...
func (c *infobasesServiceClient) Infobases(ctx context.Context, in *InfobasesRequest, opts ...grpc.CallOption) (*InfobasesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ras.service.api.v1.InfobasesService/Infobases", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infobasesServiceClient) LookupInfobase(ctx context.Context, in *LookupInfobaseRequest, opts ...grpc.CallOption) (*LookupInfobaseResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ras.service.api.v1.InfobasesService/LookupInfobase", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *infobasesServiceClient) GetInfobase(ctx context.Context, in *GetInfobaseRequest, opts ...grpc.CallOption) (*v1.InfobaseInfo, error) {
	out := new(v1.InfobaseInfo)
	err := c.cc.Invoke(ctx, "/ras.service.api.v1.InfobasesService/GetInfobase", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InfobasesServiceServer interface {
	...
	GetInfobase(context.Context, *GetInfobaseRequest) (*v1.InfobaseInfo, error)
}
...
func (UnimplementedInfobasesServiceServer) GetInfobase(context.Context, *GetInfobaseRequest) (*v1.InfobaseInfo, error) {
...
func _InfobasesService_Infobases_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ras.service.api.v1.InfobasesService/Infobases",
	}
...
func _InfobasesService_LookupInfobase_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ras.service.api.v1.InfobasesService/LookupInfobase",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _InfobasesService_GetInfobase_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ras.service.api.v1.InfobasesService/GetInfobase",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var InfobasesService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "ras/service/api/v1/infobases_request.proto",
}
