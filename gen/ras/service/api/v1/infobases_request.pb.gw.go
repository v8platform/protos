...
func RegisterInfobasesServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server InfobasesServiceServer) error {
	...
	mux.Handle("GET", pattern_InfobasesService_Infobases_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ras.service.api.v1.InfobasesService/Infobases", runtime.WithHTTPPathPattern("/infobases"))
		if err != nil {
	...
	mux.Handle("GET", pattern_InfobasesService_Infobases_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ras.service.api.v1.InfobasesService/Infobases", runtime.WithHTTPPathPattern("/clusters/{cluster.id}/infobases"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_InfobasesService_LookupInfobase_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ras.service.api.v1.InfobasesService/LookupInfobase", runtime.WithHTTPPathPattern("/infobases/lookup"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_InfobasesService_LookupInfobase_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/ras.service.api.v1.InfobasesService/LookupInfobase", runtime.WithHTTPPathPattern("/clusters/{cluster.id}/infobases/lookup"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterInfobasesServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client InfobasesServiceClient) error {
	...
	mux.Handle("GET", pattern_InfobasesService_Infobases_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ras.service.api.v1.InfobasesService/Infobases", runtime.WithHTTPPathPattern("/infobases"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_InfobasesService_Infobases_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ras.service.api.v1.InfobasesService/Infobases", runtime.WithHTTPPathPattern("/clusters/{cluster.id}/infobases"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_InfobasesService_LookupInfobase_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ras.service.api.v1.InfobasesService/LookupInfobase", runtime.WithHTTPPathPattern("/infobases/lookup"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_InfobasesService_LookupInfobase_1, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/ras.service.api.v1.InfobasesService/LookupInfobase", runtime.WithHTTPPathPattern("/clusters/{cluster.id}/infobases/lookup"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
